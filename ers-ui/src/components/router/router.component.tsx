...
import CreateReimbursement from '../reimbursements/create_reimbursement';
    ...
    return (
        <BrowserRouter>
            ...
            <Switch>
                ...
                <Route path="/createreimbursement" component={props.user.isLoggedIn?
                CreateReimbursement:()=>{return <><Redirect to="/login"/></>}} />
                <Route path="/logout"
